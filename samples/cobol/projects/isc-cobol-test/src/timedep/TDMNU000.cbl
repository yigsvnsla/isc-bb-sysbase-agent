        *================================================================*
        * TDMNU000 - MENU DE PLAZO FIJO / CERTIFICADOS DE DEPOSITO     *
        * PROPOSITO: SUBMENU DE OPERACIONES CON CDS                    *
        ...
        *
         01  WS-VARIABLES.
             ...
             05  WS-PROGRAMA-ID             PIC X(08) VALUE 'TDMNU000'.
         ...
         01  SCR-MENU.
             05  SCR-CABECERA.
                 ...
                 10  LINE 02  COL 01  PIC X(80)
                     VALUE ' MODULO PLAZO FIJO - CERTIFICADOS DE DEPOSITO'.
        ...
        *
             05  SCR-OPCIONES.
                 ...
                 10  LINE 06  COL 10  PIC X(50)
                     VALUE 'PF1  - APERTURA DE CERTIFICADO'.
                 10  LINE 07  COL 10  PIC X(50)
                     VALUE 'PF2  - CONSULTA DE CERTIFICADO'.
                 10  LINE 08  COL 10  PIC X(50)
                     VALUE 'PF3  - LIQUIDACION / CANCELACION'.
                 10  LINE 09  COL 10  PIC X(50)
                     VALUE 'PF4  - CALCULO DE INTERESES'.
        *
             05  SCR-PIE.
                 ...
                 10  LINE 24  COL 02  PIC X(78)
                     VALUE 'PF1=OPN  PF2=INQ  PF3=CLS  PF4=INT'.
                 10  LINE 24  COL 02  PIC X(78)
        ...
        *
             EVALUATE TRUE
                 WHEN WS-CRT-PF1
                     CALL 'TDOPN000' USING WS-USUARIO-ID WS-RETCODE
                     GO TO MENU-LOOP
        *
                 WHEN WS-CRT-PF2
                     CALL 'TDINQ000' USING WS-USUARIO-ID WS-RETCODE
                     GO TO MENU-LOOP
        *
                 WHEN WS-CRT-PF3
                     CALL 'TDCLS000' USING WS-USUARIO-ID WS-RETCODE
                     GO TO MENU-LOOP
        *
                 WHEN WS-CRT-PF4
                     CALL 'TDINT000' USING WS-USUARIO-ID WS-RETCODE
                     GO TO MENU-LOOP
        *
                 WHEN WS-CRT-PF11
                     CALL 'COMHELP' USING 'PLAZOFIJO'
                     GO TO MENU-LOOP
        *
                 WHEN WS-CRT-PF12
        ...
        *
                 WHEN OTHER
                     MOVE 'TECLA NO VALIDA - USE PF1 A PF4 O PF12'
                       TO WS-MENSAJE-ERROR
                     GO TO MENU-LOOP
             END-EVALUATE.
        *
        ...
        *
         5000-CONFIRMAR-SALIDA.
             ...
             DISPLAY 'CONFIRMAR SALIDA DEL MODULO? (S/N): '
