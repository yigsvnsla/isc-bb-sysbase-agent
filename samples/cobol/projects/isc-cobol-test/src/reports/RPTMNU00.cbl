       *================================================================*
       * RPTMNU00 - MENU DE REPORTES                                  *
       * PROPOSITO: ACCESO A REPORTES: BALANCE, TRANSACCIONES,        *
       *            CARTERA VENCIDA, CUADRE CAJA, GL, REGULATORIOS    *
       * EQUIPO: REPORTES - 2000                                     *
       * CALL: RPTBAL00, RPTTXN00, RPTDEL00, RPTTLR00, RPTGLB00,    *
       *       RPTREG00                                              *
       *================================================================*
      ...
      *
       01  WS-VARIABLES.
           ...
           05  WS-PROGRAMA                PIC X(08) VALUE 'RPTMNU00'.
       ...
       01  SCR-MENU.
           05  SCR-CABECERA.
               ...
               10  LINE 02  COL 01  PIC X(80)
                   VALUE ' MENU DE REPORTES'.
               10  LINE 02  COL 60  PIC X(08) FROM WS-USUARIO.
      *
           05  SCR-CUERPO.
               10  LINE 04  COL 05  PIC X(30)
                   VALUE 'REPORTES DEL SISTEMA'.
               10  LINE 05  COL 05  PIC X(70) VALUE ALL '-'.
               10  LINE 06  COL 05  PIC X(50)
                   VALUE 'PF1  - BALANCE GENERAL'.
               10  LINE 07  COL 05  PIC X(50)
                   VALUE 'PF2  - TRANSACCIONES DIARIAS'.
               10  LINE 08  COL 05  PIC X(50)
                   VALUE 'PF3  - CARTERA VENCIDA'.
               10  LINE 09  COL 05  PIC X(50)
                   VALUE 'PF4  - CUADRE DE CAJEROS'.
               10  LINE 10  COL 05  PIC X(50)
                   VALUE 'PF5  - TRIAL BALANCE (GL)'.
               10  LINE 11  COL 05  PIC X(50)
                   VALUE 'PF6  - REPORTES REGULATORIOS'.
      *
           05  SCR-PIE.
               ...
               10  LINE 24  COL 02  PIC X(78)
                   VALUE 'PF1=BAL PF2=TXN PF3=VEN PF4=CAJA '.
               10  LINE 24  COL 40  PIC X(40)
                   VALUE 'PF5=GL PF6=REG PF12=RET'.
      *
      *================================================================*
       LINKAGE SECTION.
      *
      ...
      *
           EVALUATE TRUE
               WHEN WS-CRT-PF1
                   MOVE 'RPTBAL00' TO WS-PROGRAMA-LLAMAR
                   PERFORM 3000-EJECUTAR
               WHEN WS-CRT-PF2
                   MOVE 'RPTTXN00' TO WS-PROGRAMA-LLAMAR
                   PERFORM 3000-EJECUTAR
               WHEN WS-CRT-PF3
                   MOVE 'RPTDEL00' TO WS-PROGRAMA-LLAMAR
                   PERFORM 3000-EJECUTAR
               WHEN WS-CRT-PF4
                   MOVE 'RPTTLR00' TO WS-PROGRAMA-LLAMAR
                   PERFORM 3000-EJECUTAR
               WHEN WS-CRT-PF5
                   MOVE 'RPTGLB00' TO WS-PROGRAMA-LLAMAR
                   PERFORM 3000-EJECUTAR
               WHEN WS-CRT-PF6
                   MOVE 'RPTREG00' TO WS-PROGRAMA-LLAMAR
                   PERFORM 3000-EJECUTAR
               WHEN WS-CRT-PF12
               ...
               WHEN WS-CRT-CLEAR
                   ...
                   GO TO MENU-LOOP
               WHEN OTHER
                   MOVE 'USE PF1-PF6, PF12=RETORNAR'
                     TO WS-MENSAJE-ERROR
                   GO TO MENU-LOOP
           END-EVALUATE.
      *
      ...
      *
       1000-INICIALIZAR.
           ...
           MOVE 'SELECCIONE REPORTE CON PF-KEY'
             TO WS-MENSAJE.
      ...
      *
           ...
           ELSE
               STRING WS-PROGRAMA-LLAMAR ' FINALIZADO OK'
                 INTO WS-MENSAJE
           END-IF.
      *
       9000-FINALIZAR.
