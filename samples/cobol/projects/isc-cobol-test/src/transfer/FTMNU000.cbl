       *================================================================*
       * FTMNU000 - MENU DE TRANSFERENCIAS                            *
       * PROPOSITO: SUBMENU DE OPERACIONES DE TRANSFERENCIA           *
       ...
       *
        01  WS-VARIABLES.
            ...
            05  WS-PROGRAMA-ID             PIC X(08) VALUE 'FTMNU000'.
        ...
        01  SCR-MENU.
            05  SCR-CABECERA.
                ...
                10  LINE 02  COL 01  PIC X(80)
                    VALUE ' MODULO TRANSFERENCIAS - MENU PRINCIPAL'.
       ...
       *
            05  SCR-OPCIONES.
                ...
                10  LINE 06  COL 10  PIC X(50)
                    VALUE 'PF1  - TRANSFERENCIA INTERNA'.
                10  LINE 07  COL 10  PIC X(50)
                    VALUE 'PF2  - TRANSFERENCIA WIRE'.
                10  LINE 08  COL 10  PIC X(50)
                    VALUE 'PF3  - TRANSFERENCIA ACH'.
                10  LINE 09  COL 10  PIC X(50)
                    VALUE 'PF4  - CONSULTA ESTADO TRANSFERENCIA'.
       *
            05  SCR-PIE.
                ...
                10  LINE 24  COL 02  PIC X(78)
                    VALUE 'PF1=INT  PF2=WIR  PF3=ACH  PF4=STS'.
                10  LINE 24  COL 02  PIC X(78)
       ...
       *
            EVALUATE TRUE
                WHEN WS-CRT-PF1
                    CALL 'FTINT000' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF2
                    CALL 'FTWIR000' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF3
                    CALL 'FTACH000' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF4
                    CALL 'FTSTS000' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF11
                    CALL 'COMHELP' USING 'TRANSFERENCIAS'
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF12
       ...
       *
                WHEN OTHER
                    MOVE 'TECLA NO VALIDA - USE PF1-PF4 O PF12'
                      TO WS-MENSAJE-ERROR
                    GO TO MENU-LOOP
            END-EVALUATE.
       *
