       *================================================================*
       * DEPMNU00 - MENU DE MODULO DEPOSITOS                          *
       * PROPOSITO: SUBMENU OPERACIONES DE DEPOSITOS PF1-PF6         *
       ...
       *
        01  WS-VARIABLES.
            ...
            05  WS-PROGRAMA-ID             PIC X(08) VALUE 'DEPMNU00'.
        ...
        01  SCR-MENU.
            05  SCR-CABECERA.
                ...
                10  LINE 02  COL 01  PIC X(80)
                    VALUE ' MODULO DEPOSITOS - MENU PRINCIPAL'.
       ...
       *
            05  SCR-OPCIONES.
                ...
                10  LINE 06  COL 10  PIC X(50)
                    VALUE 'PF1  - CONSULTA DE DEPOSITO'.
                10  LINE 07  COL 10  PIC X(50)
                    VALUE 'PF2  - APERTURA DE DEPOSITO'.
                10  LINE 08  COL 10  PIC X(50)
                    VALUE 'PF3  - CONFIGURACION DE TASAS'.
                10  LINE 09  COL 10  PIC X(50)
                    VALUE 'PF4  - RETIRO / WITHDRAWAL'.
                10  LINE 10  COL 10  PIC X(50)
                    VALUE 'PF5  - ESTADO DE CUENTA'.
                10  LINE 11  COL 10  PIC X(50)
                    VALUE 'PF6  - RENOVACION AUTOMATICA'.
       *
            05  SCR-PIE.
                ...
                10  LINE 24  COL 02  PIC X(78)
                    VALUE 'PF1=INQ  PF2=OPN  PF3=INT  PF4=WTH  PF5=STM'.
                10  LINE 24  COL 02  PIC X(78)
                    VALUE 'PF6=REN  PF11=AYU  PF12=RET'.
       *
       *================================================================*
        LINKAGE SECTION.
       *
       ...
       *
            EVALUATE TRUE
                WHEN WS-CRT-PF1
                    CALL 'DEPINQ00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF2
                    CALL 'DEPOPN00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF3
                    CALL 'DEPINT00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF4
                    CALL 'DEPWTH00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF5
                    CALL 'DEPSTM00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF6
                    CALL 'DEPREN00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF11
                    CALL 'COMHELP' USING 'DEPOSITOS'
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF12
       ...
       *
                WHEN OTHER
                    MOVE 'TECLA NO VALIDA - USE PF1 A PF6 O PF12'
                      TO WS-MENSAJE-ERROR
                    GO TO MENU-LOOP
            END-EVALUATE.
       *
       ...
       *
        5000-CONFIRMAR-SALIDA.
            ...
            DISPLAY 'CONFIRMAR SALIDA DEL MODULO DEPOSITOS? (S/N): '
