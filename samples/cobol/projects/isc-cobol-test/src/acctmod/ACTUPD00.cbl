       *================================================================*
       * ACTUPD00 - MODIFICACION DE CUENTA                            *
       * PROPOSITO: ACTUALIZAR PARAMETROS DE CUENTA (NO SALDOS)       *
       * EQUIPO: CONTABLE - 2004                                      *
       * ARCHIVOS: ACCOUNT (LECTURA/ESCRITURA)                        *
       *================================================================*
       ...
       *
        01  WS-VARIABLES.
            ...
            05  WS-PROGRAMA-ID             PIC X(08) VALUE 'ACTUPD00'.
            ...
            05  WS-OVERDRAFT-LIMIT-DISP    PIC S9(09)V99 COMP-3.
            05  WS-RATE-EDIT               PIC 9(03).9(04).
            05  WS-RATE-DISP               PIC 9(03)V9(04) COMP-3.
            05  WS-FEE-EDIT                PIC Z(07)9.99.
            05  WS-FEE-DISP                PIC 9(07)V99 COMP-3.
       ...
       *
                10  LINE 08  COL 05  PIC X(20) VALUE 'SOBREGIRO LIMITE:'.
                10  LINE 08  COL 30  PIC Z(09)9.99
                    USING WS-OVERDRAFT-EDIT AUTO.
       *
                10  LINE 10  COL 05  PIC X(20) VALUE 'TASA INTERES:'.
                10  LINE 10  COL 30  PIC 9(03).9(04)
                    USING WS-RATE-EDIT AUTO.
       *
                10  LINE 12  COL 05  PIC X(20) VALUE 'COMISION MENSUAL:'.
                10  LINE 12  COL 30  PIC Z(07)9.99
                    USING WS-FEE-EDIT AUTO.
       *
                10  LINE 14  COL 05  PIC X(15) VALUE 'OFICIAL:'.
                10  LINE 14  COL 22  PIC X(08)
       ...
       *
                WHEN OTHER
                    MOVE 'USE ENTER=CONS PF3=GURDAR PF12=SALIR'
                      TO WS-MENSAJE-ERROR
                    GO TO UPDATE-LOOP
            END-EVALUATE.
       *
       ...
       *
        1000-INICIALIZAR.
            ...
            MOVE 'INGRESE CUENTA, ENTER=CONS, PF3=GUARDAR'
              TO WS-MENSAJE.
       ...
       *
            IF FL-ACCOUNT-STATUS = '00'
                MOVE ACT-OVERDRAFT-LIMIT TO WS-OVERDRAFT-LIMIT-DISP
                MOVE WS-OVERDRAFT-LIMIT-DISP TO WS-OVERDRAFT-EDIT
                MOVE ACT-INTEREST-RATE TO WS-RATE-DISP
                MOVE WS-RATE-DISP TO WS-RATE-EDIT
                MOVE ACT-MONTHLY-FEE TO WS-FEE-DISP
                MOVE WS-FEE-DISP TO WS-FEE-EDIT
                MOVE 'CUENTA ENCONTRADA - MODIFIQUE CAMPOS'
                  TO WS-MENSAJE
            ELSE
       ...
       *
            ...
            ACCEPT WS-CONFIRMA AT LINE 23 COLUMN 42.
       ...
       *
            ...
            MOVE WS-RATE-EDIT TO WS-RATE-DISP.
            MOVE WS-RATE-DISP TO ACT-INTEREST-RATE.
            MOVE WS-FEE-EDIT TO WS-FEE-DISP.
            MOVE WS-FEE-DISP TO ACT-MONTHLY-FEE.
       ...
       *
            IF FL-ACCOUNT-STATUS = '00'
                ...
                MOVE 'CUENTA ACTUALIZADA EXITOSAMENTE' TO WS-MENSAJE
            ELSE
