       *================================================================*
       * ACTMNU00 - MENU DE MODULO CUENTAS                            *
       * PROPOSITO: SUBMENU OPERACIONES DE CUENTAS PF1-PF7            *
       ...
       *
        01  WS-VARIABLES.
            ...
            05  WS-PROGRAMA-ID             PIC X(08) VALUE 'ACTMNU00'.
        ...
        01  SCR-MENU.
            05  SCR-CABECERA.
                ...
                10  LINE 02  COL 01  PIC X(80)
                    VALUE ' MODULO CUENTAS - MENU PRINCIPAL'.
       ...
       *
            05  SCR-OPCIONES.
                ...
                10  LINE 06  COL 10  PIC X(50)
                    VALUE 'PF1  - CONSULTA DE CUENTA'.
                10  LINE 07  COL 10  PIC X(50)
                    VALUE 'PF2  - APERTURA DE CUENTA'.
                10  LINE 08  COL 10  PIC X(50)
                    VALUE 'PF3  - MODIFICACION DE CUENTA'.
                10  LINE 09  COL 10  PIC X(50)
                    VALUE 'PF4  - CIERRE DE CUENTA'.
                10  LINE 10  COL 10  PIC X(50)
                    VALUE 'PF5  - CONGELAR / DESCONGELAR'.
                10  LINE 11  COL 10  PIC X(50)
                    VALUE 'PF6  - CONSULTA DE SALDO'.
                10  LINE 12  COL 10  PIC X(50)
                    VALUE 'PF7  - ESTADO DE CUENTA'.
       *
            05  SCR-PIE.
                ...
                10  LINE 24  COL 02  PIC X(78)
                    VALUE 'PF1=INQ PF2=OPN PF3=UPD PF4=CLS PF5=FRZ'.
                10  LINE 24  COL 02  PIC X(78)
                    VALUE 'PF6=BAL PF7=STM PF11=AYU PF12=RET'.
       *
       *================================================================*
        LINKAGE SECTION.
       *
       ...
       *
                WHEN WS-CRT-PF2
                    CALL 'ACTOPN00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF3
                    CALL 'ACTUPD00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF4
                    CALL 'ACTCLS00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF5
                    CALL 'ACTFRZ00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF6
                    CALL 'ACTBAL00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF7
                    CALL 'ACTSTM00' USING WS-USUARIO-ID WS-RETCODE
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF11
                    CALL 'COMHELP' USING 'CUENTAS'
                    GO TO MENU-LOOP
       *
                WHEN WS-CRT-PF12
       ...
       *
        5000-CONFIRMAR-SALIDA.
            ...
            DISPLAY 'SALIR DEL MODULO CUENTAS? (S/N): '
                AT LINE 23 COLUMN 05.
            ACCEPT WS-DUMMY AT LINE 23 COLUMN 42.
